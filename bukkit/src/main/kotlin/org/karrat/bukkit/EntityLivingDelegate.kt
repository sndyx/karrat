...
public open class EntityLivingDelegate(
    public val underlyingEntityLiving: EntityLiving,
) : EntityDelegate(underlyingEntityLiving), BukkitEntityLiving {
    ...
    override fun getKiller(): BukkitPlayer? {
        TODO("Not yet implemented")
    }
    ...
    override fun hasLineOfSight(other: BukkitEntity): Boolean {
        TODO("Not yet implemented")
    }
    ...
    override fun getLeashHolder(): BukkitEntity {
        TODO("Not yet implemented")
    }
    
    override fun setLeashHolder(holder: BukkitEntity?): Boolean {
        TODO("Not yet implemented")
    }
    ...
    override fun attack(target: BukkitEntity) {
        TODO("Not yet implemented")
    }
