...
class CompressionHandler(val compressionThreshold : Int) {
    val inflater = Inflater()
    val deflater = Deflater()

    fun decompress(buffer : ByteBuffer) {
        ...
        val compressed = buffer.readBytes(buffer.remaining)
    ...
    fun compress(buffer : ByteBuffer) {
